...
libraryDependencies += "io.gatling" % "gatling-app" % "2.0.0-RC5"

libraryDependencies += "io.gatling.highcharts" % "gatling-charts-highcharts" % "2.0.0-RC5" exclude("io.gatling", "gatling-recorder")
