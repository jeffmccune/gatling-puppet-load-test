...
class FOSS360rc_CatalogZero extends com.puppetlabs.gatling.runner.SimulationWithScenario {
	...
	val chain_0 =
		exec(http("node")
					.get("/production/node/puppet-agent")
			)
